...
const PurchasedOrderProductAddUpdateModal = ({ show, onHide, modelRequestData,
                  ...
                  <Modal.Header closeButton>
                        <Modal.Title>
                              <h3 className="text-center">
                                    {editIndex !== null ? 'Update PO Product' : 'Add PO Product'}
                              </h3>
...
export default PurchasedOrderProductAddUpdateModal;
