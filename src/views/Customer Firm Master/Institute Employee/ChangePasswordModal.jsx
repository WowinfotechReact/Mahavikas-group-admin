...
import { AssignWebAppUserAndSetPassword, UpdateWebAppUserPassword } from 'services/Employee Staff/EmployeeApi';
import { ERROR_MESSAGES } from 'component/GlobalMassage';
import { ConfigContext } from 'context/ConfigContext';
import SuccessPopupModal from 'component/SuccessPopupModal';

function ChangePasswordModal({ show, onHide, modelRequestData, setIsAddUpdateActionDone }) {
      ...
      const Submit = async () => {
            ...
            const apiParam = {
                  ...
                  userID: modelRequestData.userID,
      ...
      const AddUpdateAppUserData = async (apiParam) => {
            ...
            setLoader(true)
            try {
                  let url = '/UpdateWebAppUserPassword'; // Default URL for Adding Data

                  const response = await UpdateWebAppUserPassword(url, apiParam);
                  if (response) {
            ...
            <Modal backdrop="static" keyboard={false} style={{ zIndex: 1300 }} show={show} onHide={onHide} centered>
                  ...
                  <Modal.Footer>
                        ...
                        <button onClick={() => Submit()} style={{ background: '#ffaa33', height: '40px', color: 'white' }} className="btn  btn-sm d-none d-sm-inline">
                              <span className="d-none d-sm-inline"> Yes , Change</span>
                        </button>
