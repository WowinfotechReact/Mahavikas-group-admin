...
const SIMTableData = [
  {
    ...
    statusIM: 'Active',
    lastUpdate: '2024-12-01',
    offlineFrom: '2024-12-01',
    onlineCommand: '2024-12-01'
  },
  {
    id: 2,
    vehicleNumber: 'ABC123',
      ...
      <div className="  bg-white shadow-md rounded-lg">
        <div className="d-flex justify-content-between align-items-center mb-1 w-100">
          ...
          <div className="d-flex gap-3 col-12 col-md-auto justify-content-end">
            <button className="btn btn-primary">Vihaana Duplicate Vehicle Number</button>
    ...
    <div className=" w-full max-w-[50vh] mx-auto h-auto">
      <div className="  bg-white shadow-md rounded-lg">
        <div className="d-flex justify-content-between align-items-center mb-1 w-100">
          ...
          <div className="d-flex gap-3 col-12 col-md-auto justify-content-end">
            <button className="btn btn-primary">Duplicate Vihaana Vehicle Number</button>
            {/* <button className="btn btn-primary">Back</button> */}
          </div>
        </div>
    ...
    <div className="w-full max-w-[50vh] mx-auto h-auto">
      <div className="  bg-white shadow-md rounded-lg">
        <div className="d-flex justify-content-between align-items-center mb-1 w-100">
          {/* Left Section: Title and Search Bar */}
          <div className="d-flex justify-content-start gap-3 align-items-center col-12 col-md-auto">
            <h4 className="text-nowrap">Vihaana Offline </h4>
            <input
              style={{ width: '250px' }} // Adjust width as needed
              type="text"
              className="form-control mx-2"
          ...
          <div className="d-flex gap-3 col-12 col-md-auto justify-content-end">
            <button className="btn btn-primary"> Vihaana Offline</button>
          ...
          <table className="table table-bordered table-striped">
            <thead className="table-light" style={{ position: 'sticky', top: -1, zIndex: 1 }}>
              <tr>
                ...
                <th className="text-center">Last Update</th>
                <th className="text-center">Offline From</th>
                <th className="text-center">Online Command</th>
              </tr>
            </thead>
            <tbody>
              {SIMTableData?.map((row, idx) => (
                <tr key={idx}>
                  ...
                  <td className="text-center">{row.statusIM}</td>
                  <td className="text-center">{row.lastUpdate}</td>
                    <td className="text-center">{row.offlineFrom}</td>
                    <td className="text-center">{row.onlineCommand}</td>
                </tr>
              ))}
            </tbody>
          </table>
    ...
    <div className="w-full max-w-[50vh] mx-auto h-auto">
      <div className="  bg-white shadow-md rounded-lg">
        <div className="d-flex justify-content-between align-items-center mb-1 w-100">
          {/* Left Section: Title and Search Bar */}
          <div className="d-flex justify-content-start gap-3 align-items-center col-12 col-md-auto">
            <h4 className="text-nowrap">Days To Expire Table</h4>
            <input
              style={{ width: '250px' }} // Adjust width as needed
              type="text"
              className="form-control mx-2"
    ...
    <div className="w-full max-w-[50vh] mx-auto h-auto">
      <div className="  bg-white shadow-md rounded-lg">
        <div className="d-flex justify-content-between align-items-center mb-1 w-100">
          {/* Left Section: Title and Search Bar */}
          <div className="d-flex justify-content-start gap-3 align-items-center col-12 col-md-auto">
            <h4 className="text-nowrap">SVTS Offline Table</h4>
            <input
              style={{ width: '250px' }} // Adjust width as needed
              type="text"
              className="form-control mx-2"
...
export default VihaanaCollection;
