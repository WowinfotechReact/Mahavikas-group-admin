...
const AddUpdateBloodGroup = ({ show, onHide, setIsAddUpdateActionDone, modelRequestData }) => {
        ...
        <Modal.Header closeButton>
          <Modal.Title>
            <h3 className="text-center">
              {modelRequestData?.Action !== null ? 'Update Blood Group' : modelRequestData?.Action === null ? 'Add Blood Group' : ''}
            </h3>
          </Modal.Title>
        </Modal.Header>
...
export default AddUpdateBloodGroup;
