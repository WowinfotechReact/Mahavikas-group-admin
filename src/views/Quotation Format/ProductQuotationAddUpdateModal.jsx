...
const ProductQuotationAddUpdateModal = ({ show, onHide, setIsAddUpdateActionDone, isAddUpdateActionDone, modelRequestData,
...
export default ProductQuotationAddUpdateModal;
