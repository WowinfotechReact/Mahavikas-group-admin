...
const OemProductAddUpdateModal = ({ show, onHide, setIsAddUpdateActionDone, isAddUpdateActionDone, modelRequestData,
      ...
      const AddProductBtnClick = (e) => {
            ...
            if (
                  ...
                  quotationProductObj.rate === null || quotationProductObj.rate === undefined || quotationProductObj.rate === '' // 🔁 skip if format is 2
            ) {
                  setErrors(true);
                  isValid = true;
            } else {
            ...
            if (!isValid) {
                  ...
                  const cleanedProductObj = {
                        ...
                        oempoProductMapID: quotationProductObj?.oempoProductMapID ?? null, // Set to null if undefined
