...
const SalesOrderProductAddUpdateModal = ({ show, onHide, setIsAddUpdateActionDone, isAddUpdateActionDone, modelRequestData,
...
export default SalesOrderProductAddUpdateModal;
